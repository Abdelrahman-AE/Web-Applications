  ...
  return (
    <header className='bg-black text-white fixed top-0 left-0 right-0'>
        <nav className='px-4 py-4 max-w-7xl mx-auto flex justify-between items-center'>
            ...
            <ul className='md:flex gap-12 tex-lg hidden'>
                {
            ...
            <div className='text-white lg:flex gap-4 items-center hidden'>
                ...
                tansition-all duration-200 ease-in'>Log in</button>
            </div>
        ...
        <div>
        <ul className={'md:hidden gap-12 tex-lg black space-y-4 px-4 py-6 mt-14 bg-white ${isMenuOpen ? "fixed top-0 left-0 w-full transition-all ease-out duration-150" : "hidden"}'}>
                {
