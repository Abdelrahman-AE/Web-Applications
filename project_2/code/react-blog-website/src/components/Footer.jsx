        ...
        <div className='grid mb-8 lg:grid-cols-6'>
            ...
            <div className='md:max-w-md lg:col-span-2 lg:mt-0 mt-5'>
                    ...
                    <form className='mt-4 flex flex-col md:flex-row'>
                        ...
                        duration-200 bg-white border border-gray-300 rounded shadow-sm aspect-auto md:mr-2 md:mb-0 
                        focus:border-purple-400 focues:outline-none' />
                    ...
                    <p className='mt-4 text-sm text-gray-500 '>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Cupiditate, id? Mollitia quis eos dolorem 
                        adipisci cum sunt doloribus iste laboriosam corporis deleniti, officia culpa asperiores perferendis 
                        facere quidem beatae? Neque?</p>
                </div>
